      ...
      <div className="flex items-center gap-4 lg:gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title="Create New Capstone Project"
            aria-label="Create New Capstone Project"
            className="hidden sm:flex items-center gap-1.5 rounded-lg bg-indigo-600 px-2.5 py-1.5 text-xs font-semibold text-white shadow-xs hover:bg-indigo-700 transition focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
          >
            <Plus className="h-3.5 w-3.5" />
